...
namespace PrestamosApi.Migrations
{
    ...
    [Migration("20260121215952_AddPagoCostoAndTotalPagado")]
    partial class AddPagoCostoAndTotalPagado
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrestamosApi.Models.ConfiguracionSistema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PrestamosApi.Models.Costo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PrestamosApi.Models.PagoCosto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CostoId")
                        .HasDatabaseName("idx_pagoscostos_costo");

                    b.HasIndex("FechaPago")
                        .HasDatabaseName("idx_pagoscostos_fecha");

                    b.ToTable("pagoscostos", (string)null);
                });
            ...
            modelBuilder.Entity("PrestamosApi.Models.PagoCosto", b =>
                {
                    b.HasOne("PrestamosApi.Models.Costo", "Costo")
                        .WithMany("Pagos")
