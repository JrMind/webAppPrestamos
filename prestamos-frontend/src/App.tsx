    ...
    <div className="dashboard">
      ...
      <main className="main-content">
        ...
        <div className="kpi-grid">
          ...
          <div className="kpi-card"><div className="kpi-header"><span className="kpi-title">Renta Congelados Mes</span></div><span className="kpi-value" style={{ color: '#10b981' }}>{formatMoney(metricas?.rentaCongeladosMes || 0)}</span><span className="kpi-sub" style={{ marginTop: '0.5rem', color: '#999' }}>Sumatoria de los intereses mensuales a cobrar</span></div>
        </div>
        ...
        <div className="kpi-grid" style={{ marginTop: '1rem' }}>
          <div className="kpi-card" style={{ borderLeft: '4px solid #f59e0b', background: 'linear-gradient(135deg, rgba(245,158,11,0.1) 0%, transparent 100%)' }}>
            <div className="kpi-header"><span className="kpi-title">💰 Capital Circulante</span></div>
        ...
        <div className="section">
          <div className="tabs">
            ...
            {currentUser?.rol !== 'Administrador' && <button className={`tab ${activeTab === 'ganancias' ? 'active' : ''}`} onClick={() => { setActiveTab('ganancias'); loadResumenParticipacion(); loadCostos(); loadGastos(); }}>📊 Ganancias</button>}
